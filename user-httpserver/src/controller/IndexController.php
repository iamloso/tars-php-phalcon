...
use HttpServer\servant\UserHttpServer\UserBaseServer\UserObj\ServiceInterfaceServant;
...
class IndexController extends Controller
{
    ...
    public function actionRequest()
    {
        ...
        $servant = new ServiceInterfaceServant($config);
        $result = $servant->request();
        $this->sendRaw('result:'.var_export($result, true));
    }
